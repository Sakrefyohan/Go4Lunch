...
import static sakref.yohan.go4lunch.ui.InstrumentActivityTest.intentUser;
...
public class MainActivityTest {
    ...
    public void connectionTest() {
        ...
        intentUser.putExtra("email", "neyiy76990@nefacility.com");
        intentUser.putExtra("photoUrl", "lien de photo");
        intentUser.putExtra("uid", "13216816524");
        mActivityTestRule.launchActivity(intentUser);
